			...
			var editor1 = K.create('textarea[name="content"]', {
				...
				afterCreate : function() {
					...
					K.ctrl(document, 13, function() {
						self.sync();
						K('form[name=articleForm]')[0].submit();
					});
...
<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">文章管理 <small>    发布新文章</small></h3>
...
<tr style="height: 50px;">
 <td><strong class="btn green-stripe">文章标题</strong></td>
 <td>
<span class="frm_input_box">
<input name="user[title]" type="text"  id="title"   class="frm_input" style="width: 200px;" value="<?php echo ($user["title"]); ?>" /></span>
                    </td>
</tr>
 <tr style="height: 50px;">
 <td><strong class="btn green-stripe">副标题</strong></td>
 <td>
<span class="frm_input_box">
<input name="user[title_sub]" type="text"  id="title_sub"   class="frm_input" style="width: 200px;" value="<?php echo ($user["title_sub"]); ?>" /></span>
       <span>&nbsp;&nbsp;例:40k-8k 经验3-5年/不限</span>              </td>
</tr>
  <tr  >
 <td><strong class="btn green-stripe">类型</strong></td>
 <td>  <select name="user[type]" style="width:180px">
<option value="">选择</option>
 <option value="1"<?php if(($user['type']) == "1"): ?>selected<?php endif; ?>>关于我们</option>
<option value="2"<?php if(($user['type']) == "2"): ?>selected<?php endif; ?>>联系我们</option>
<option value="3"<?php if(($user['type']) == "3"): ?>selected<?php endif; ?>>付费方案</option>
<option value="4"<?php if(($user['type']) == "4"): ?>selected<?php endif; ?>>由来</option>
<option value="5"<?php if(($user['type']) == "5"): ?>selected<?php endif; ?>>文化</option>
<option value="6"<?php if(($user['type']) == "6"): ?>selected<?php endif; ?>>团队</option>
<option value="7"<?php if(($user['type']) == "7"): ?>selected<?php endif; ?>>招聘</option>

 </select>         </td>
</tr>
 <tr  >
 <td><strong class="btn green-stripe">内容</strong></td>
 <td>
   <textarea name="content" style="width:770px;height:500px;visibility:hidden;"><?php echo htmlspecialchars($user['content']); ?></textarea>
                    </td>
</tr>
            </table>
