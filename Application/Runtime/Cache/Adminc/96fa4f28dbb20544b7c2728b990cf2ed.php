...
.radio input[type="radio"], .checkbox input[type="checkbox"] {
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
	<?php if(($ui['ad_add']) == "active"): ?>首页广告管理<small>   Template editing system</small><?php else: ?>友情链接管理 <small>   Edit user case</small><?php endif; ?> 
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
  ...
  <?php if(($ui['ad_add']) == "active"): ?><li class=""> 
...
<?php if(($ui["ad_add"]) == "active"): ?><li class=""> 
<a href="<?php echo U('ad/index');?>"> 首页广告列表</a> 
            </li>
                <li class="active"> 
                <a href=""> 首页广告编辑 </a> </li>
<?php else: ?>
  <li class=""> 
<a href="<?php echo U('ad/friendlinks');?>"> 友情链接列表</a> 
            </li>
                <li class="active"> 
                <a href=""> 友情链接编辑 </a> </li><?php endif; ?>  
 ...
 <tr><td style="width: 98px;">网站名称：</td>
                    <td colspan="2"><span class="frm_input_box">
                            <input name="ad[name]" type="text"  id="title"  class="frm_input"  value="<?php echo ($ad["name"]); ?>" /></span></td></tr>  
...
<img src="/Uploads/<?php echo ((isset($ad["logo"]) && ($ad["logo"] !== ""))?($ad["logo"]):"jia_thum.jpg"); ?>   " alt="" style="max-height: 160px; line-height: 20px;"></div>
<div class="fileupload-preview fileupload-exists thumbnail" style="max-height: 220px; line-height: 20px;"></div>
<div><span class="btn btn-file"><span class="fileupload-new">上传图片</span>
													<span class="fileupload-exists">改变</span>
                                                    <input type='file'  name='photo2' class="default"> 
												</span>
													<a href="#" class="btn fileupload-exists" data-dismiss="fileupload">删除</a>
											  </div></div></div></td></tr>
                 <tr><td style="width: 98px;">链接地址：</td>
                    <td colspan="2"><span class="frm_input_box">
                            <input name="ad[url]" type="text"    class="frm_input"  value="<?php echo ($ad["url"]); ?>" />

                            </span></td></tr> 
                
                 <tr><td style="width: 98px;">网站简介：</td>
                    <td colspan="2"><span class="frm_input_box">
                            <textarea name="ad[link]" cols="45" rows="5"><?php echo ($ad["link"]); ?></textarea>
                            </span></td></tr> 
                <tr>
                   <td style="width: 98px;">
                    </td>
                    <td colspan="2">
                                      <div class="with_form span10"  style="margin:10px 0 80px">
                             <input type="hidden"  name="pageCode" value="<?php echo ($ad["home"]); ?>" />  
                             <input type="hidden"  name="id" value="<?php echo ($ad["id"]); ?>" />           
          <button class="btn blue btn-block" id="Span1" type="submit" >保存 <i class="m-icon-swapright m-icon-white"></i></button>
            </div>
