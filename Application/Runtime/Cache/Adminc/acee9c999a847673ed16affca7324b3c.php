...
<div class="container-fluid">
       ...
       <tr> 
      <td  height="48" align="right"><strong>关闭了的场景：</strong></td>
      <td><input type="text" name="sys_link_arr[close]" value="<?php echo (C("sys_link_arr.close")); ?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例:http://e.wesambo.com/v-U60606SS356  </span>
    </tr> 
   
    <tr> 
      <td  height="48" align="right"><strong>正在审核的场景：</strong></td>
      <td><input type="text" name="sys_link_arr[noshenhe]" value="<?php echo (C("sys_link_arr.noshenhe")); ?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例:http://e.wesambo.com/v-U60606SS356  </span>
    </tr> 
           <tr> 
      <td  height="48" align="right"><strong>地址失效的场景：</strong></td>
      <td><input type="text" name="sys_link_arr[visit_invalid]" value="<?php echo (C("sys_link_arr.visit_invalid")); ?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例:http://e.wesambo.com/v-U60606SS356  </span>
    </tr> 
