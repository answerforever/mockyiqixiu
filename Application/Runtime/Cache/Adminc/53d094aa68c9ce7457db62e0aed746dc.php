...
<?php if($filetype == 1): ?><!-- BEGIN PAGE CONTENT-->
					...
					<div class="tabbable tabbable-custom tabbable-full-width">
                      <?php if($ui["File_index"] == 'active'): ?><ul class="nav nav-tabs">
                        <?php if(($flag) == "useranli"): ?><li class="<?php if(($fnid) == ""): ?>active<?php endif; ?>"><a  href="<?php echo U('/File/index/flag/useranli/0');?>" >全部</a></li>
							...
							<li class="<?php if(($fnid) == "104"): ?>active<?php endif; ?>"><a href="<?php echo U('/File/lists/filetype/1/fnid/1301');?>">背景</a></li><?php endif; ?>
						</ul>
                       <hr> 
	...
	<a class="fancybox-button" data-rel="fancybox-button" title="图片ID：<?php echo ($item["fileid_bigint"]); ?>，添加时间：<?php echo ($item["create_time"]); ?>，文件类型：<?php echo ($item["ext_varchar"]); ?>" href="/Uploads/<?php echo ($item["filesrc_varchar"]); ?>">
	  ...
	  <?php if($ui["File_index"] == 'active'): ?><a href="/Uploads/<?php echo ($item["filesrc_varchar"]); ?>" class="icon"  target="_blank"><i class="icon-link"></i></a>
		<a href="?c=File&a=e&id=<?php echo ($item["fileid_bigint"]); ?>&filetype=<?php echo ($item["filetype_int"]); ?>" class="icon"><i class="icon-pencil"></i></a>
		<a href="javascript:;" onClick="javascript:if(confirm('你确信要删除[<?php echo ($item["filename_varchar"]); ?>]吗？')) window.location='?c=File&a=del&id=<?php echo ($item["fileid_bigint"]); ?>'" class="icon"><i class="icon-remove"></i></a> 
 <?php else: ?>
 ...
 <a href="?c=File&a=userancs_e&id=<?php echo ($item["fileid_bigint"]); ?>&filetype=<?php echo ($item["filetype_int"]); ?>" class="icon"><i class="icon-pencil"></i></a>
		<a href="javascript:;" onClick="javascript:if(confirm('你确信要删除[<?php echo ($item["filename_varchar"]); ?>]吗？')) window.location='?c=File&a=userancs_del&id=<?php echo ($item["fileid_bigint"]); ?>'" class="icon"><i class="icon-remove"></i></a><?php endif; ?>  
             ...
             <div class="portlet-body" style=" margin-top:15px;">
														<table class="table table-striped table-bordered table-advance table-hover">
                                                            ...
                                                            <?php if(is_array($select)): foreach($select as $key=>$item): ?><tr>
																	<td><a href="#"> <?php echo ($item["fileid_bigint"]); ?> </a></td>
                ...
                <a href="javascript:;" onClick="javascript:if(confirm('你确信要删除[<?php echo ($item["filename_varchar"]); ?>]吗？')) window.location='?c=File&a=del&id=<?php echo ($item["fileid_bigint"]); ?>'" class="btn"> <i class="icon-remove icon-white"></i> 删除</a> <?php else: ?>
                ...
                <a href="javascript:;" onClick="javascript:if(confirm('你确信要删除[<?php echo ($item["filename_varchar"]); ?>]吗？')) window.location='?c=File&a=userancs_del&id=<?php echo ($item["fileid_bigint"]); ?>'" class="btn"> <i class="icon-remove icon-white"></i> 删除</a><?php endif; ?>  
