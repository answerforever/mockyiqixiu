       ...
       <form action="" method="post" class="form-horizontal">
            ...
            <table style="vertical-align: top;">
                <tr>
                    ...
                    <td>
                  <input name="site_name" type="text" value="<?php echo (C("site_name")); ?>" /><span>&nbsp;&nbsp;例：易企秀</span>
                    </td>
                </tr>
         <tr> 
      <td   align="right">网站地址：</td>
      <td><input type="text" name="site_url" value="<?php echo (C("site_url")); ?>" <span>&nbsp;&nbsp;例:http://127.0.0.1</span></td>
    </tr>  
                   <tr>
...
<tr> 
      <td  align="right">是否开启手机版首页：</td>
      <td>
      
                    <div class="controls">
														<label class="radio">
														<div class="radio"><span class="checked">
                  <input type="radio" id="open_mobile1" name="open_mobile" value="1" <?php if(C('open_mobile')==1): ?>   checked='checked'  <?php endif; ?> /><label for="open_mobile1">
                                                        </span></div>
开启
														</label>
														<label class="radio">
														<div class="radio"><span class="">
                <input type="radio" id="open_mobile2"  name="open_mobile" value="0" <?php if(C('open_mobile')==0): ?>   checked='checked'  <?php endif; ?> /><label for="open_mobile2">
                                                        </span></div>
关闭
														</label>  
...
<span> 默认：#d0cfd8 </span></td>
     ...
     <tr> 
      ...
      <td><input type="text" name="lastpagetext" value="<?php echo (C("lastpagetext")); ?>" style="width:120px"/><span>&nbsp;&nbsp;例：易企秀</span> &nbsp;&nbsp;
...
<span> 默认：#23a3d3 </span></td>
     ...
     <tr> 
      ...
      <td><input type="text" name="lastpagelink" value="<?php echo (C("lastpagelink")); ?>"/><span>&nbsp;&nbsp;例：http://127.0.0.1</span></td>
    </tr>
