...
<div class="container-fluid">
	...
	<tr> 
	 ...
	 <tr> 
      <td  align="right"><strong>调试模式：</strong></td>
      <td>
      
                    <div class="controls" style="margin-left:0">
														<label class="radio">
														<div class="radio"><span class="checked">
                  <input id="ctl00_ContentPlaceHolder1_rdiIsEnable_help_0" type="radio" name="sdk_debug" value="1" <?php if(C('sdk_debug')==1): ?>   checked='checked'  <?php endif; ?> /><label for="ctl00_ContentPlaceHolder1_rdiIsEnable_help_0">
                                                        </span></div>
开启
														</label>
														<label class="radio">
														<div class="radio"><span class="">
                <input id="ctl00_ContentPlaceHolder1_rdiIsEnable_help_1" type="radio"   name="sdk_debug" value="0" <?php if(C('sdk_debug')==0): ?>   checked='checked'  <?php endif; ?> /><label for="ctl00_ContentPlaceHolder1_rdiIsEnable_help_1">
                                                        </span></div>
关闭
														</label>  
