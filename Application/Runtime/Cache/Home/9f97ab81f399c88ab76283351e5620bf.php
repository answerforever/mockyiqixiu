...
<html lang="en"><head>
    ...
    <meta id="metaDescription" name="description" content="<?php echo (stripslashes($confinfo2[title])); ?>" />
...
<style>
        ...
        .kpicon::before{
            ...
            z-index: 10;
            content: '';
            background-image: url('<?php echo C("lastpagelink") ?>/Uploads/<?php if($sceneinfo[loadinglogo]): echo ($sceneinfo[loadinglogo]); else: echo ($confinfo2[imgsrc]); ?> <?php endif; ?>');"></div>
        }
        .kpicon_loaders{
            position: absolute;
            z-index: 20;
